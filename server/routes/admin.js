...
router.get('/', auth.optional, adminController.admin_count_get)
...
router.get('/coursesInvalid', auth.optional, adminController.admin_courses_invalid_get)

// 06 - Récupérer la liste des projects
router.get('/projects', auth.optional, adminController.admin_projects_get)

// 14 - Récupérer la liste des users
router.get('/users/students', auth.optional, adminController.admin_users_student_get)
// 14 - Récupérer la liste des users
router.get('/users/teachers', auth.optional, adminController.admin_users_teachers_get)
...
router.get('/project/delete/:id_projet', auth.optional, adminController.admin_project_delete_post)
...
router.get('/user/delete/:id_user', auth.optional, adminController.admin_user_delete)

// 19 - rejected course 
router.get('/course/rejected/:id_course', auth.optional, adminController.admin_rejected_course)
...
router.get('/course/delete/:id_courses', auth.optional, adminController.admin_course_delete_post)
...
router.get('/course/validated/:id_user/:id_course', auth.optional, adminController.admin_validated_course)
